...
function defaultChallenges(): Challenge[] {
  return [
    {
      id: "daily-distance",
      label: "Reach 10,000m without crashing",
      progress: 0,
      goal: 10000,
      reward: 150,
      complete: false,
    ...
    {
      id: "daily-no-boost",
      label: "Complete a run without using boosts",
      progress: 0,
      goal: 1,
      reward: 75,
      complete: false,
          ...
          const challenges = state.challenges.map((challenge) => {
            const progress =
              challenge.id === "daily-distance"
                ...
                : challenge.id === "weekly-coins"
                  ? challenge.progress + collectedThisRun
                  : !boostsUsed
                    ? Math.max(challenge.progress, 1)
                    : challenge.progress;
          ...
          <div className="text-center">
            ...
            <div className="mx-auto mb-5 max-w-xl rounded-xl border border-cyan-400/20 bg-cyan-400/5 p-4 text-left text-sm">
              <div className="mb-3 flex items-center justify-between">
                <p className="font-bold text-cyan-200">Daily / Weekly Challenges</p>
